...
export default  function Card({title, id, type, description, picture, start_date, end_date}: ReusableCardProps){
        ...
        <div onClick={handleClick}
            ...
            <div className="flex h-full">
                ...
                <div className="w-1/3 relative">
                    <Image
                        src={picture || (type === 'group'? '/images/group_profile.png': '/images/travel.jpg')}
                        alt={title}
                        layout="fill"
                        objectFit="cover"
                    />
