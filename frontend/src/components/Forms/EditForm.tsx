...
// }
//
// export default function EditForm({ config, buttonText, action, onClose }: EditFormProps) {
...
export default function EditForm({ config, buttonText, action, onClose, initialValues }: EditFormProps) {
    const [state, formAction] = useActionState(action, {
        errors: {},
        success: false,
        message: '',
            ...
            {config.map((field) => (
                <div key={field.labelId} className="space-y-2">
                  ...
                  hover:file:bg-purple-100"
                            ...
                            {!filePreview && initialValues?.[field.labelId] &&(
                                <img src={initialValues?.[field.labelId] || ''} alt="Preview" className="mt-2 h-20 w-20 object-cover rounded-full" />
                            )}
                        </div>
                    ) : (
                        <input
