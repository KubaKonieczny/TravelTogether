...
class GroupViewSet(viewsets.ViewSet):
    ...
    def invitations(self, request, pk=None):
        ...
        group_members = Group_Members.objects.filter(group=group, type='invitation', status='pending').select_related(
            'user')
    ...
    def requests(self, request, pk=None):
        ...
        trip_members = Group_Invitations.objects.filter(group=group, type='request', status='pending').select_related(
            'user')
        serializer = GroupMemberSerializer(trip_members, many=True)
